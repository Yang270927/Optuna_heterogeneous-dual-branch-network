...
def show_history(history):
    ...
    plt.plot(history.epoch, history.history['xc_accuracy'], label='train_acc')
    plt.plot(history.epoch, history.history['val_xc_accuracy'], label='val_xc_accuracy')
    plt.legend()    
    plt.savefig('figure/total_acc.png')
    plt.close()

    train_acc=history.history['xc_accuracy']
    val_acc=history.history['val_xc_accuracy']
