...
model = culstm.DAE(weights=None,input_shape=[1024,2], classes=8)
...
def predict(model):
    ...
    mltools.plot_confusion_matrix(confnorm, labels=['16QAM', '64QAM', '8PSK', 'AM-DSB-SC', 'AM-SSB-SC', 'BPSK', 'GMSK', 'QPSK'],save_filename='figure/lstm3_total_confusion.png')
